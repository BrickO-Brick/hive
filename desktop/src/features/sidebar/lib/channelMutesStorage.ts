 ...
 * pubkey-only key so users don't lose their mutes on upgrade. Migrated data is
 ...
 * relay, which would let relay A's mutes seed-publish onto relay B (Carl P1).
 *
