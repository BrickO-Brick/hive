  ...
  return (
    <div className="relative pb-1 pt-0.5">
      ...
      <button
        ...
        className="group relative isolate inline-flex h-[1.875rem] w-fit max-w-full cursor-pointer items-center gap-1.5 rounded-full py-0 pr-3 text-left text-xs font-medium text-muted-foreground hover:text-foreground hover:opacity-90 focus-visible:outline-hidden"
            ...
            {summary.lastReplyAt ? (
              <>
                ...
                <span className="inline-grid font-normal text-muted-foreground/70">
                  <span
                    className="col-start-1 row-start-1 group-hover:opacity-0 group-focus-visible:opacity-0"
                  ...
                  <span
                    className="col-start-1 row-start-1 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100"
