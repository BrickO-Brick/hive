export const ONBOARDING_PREVIEW_CARD_INPUT_CLASS =
...
/** Quiet V3 actions use the same translucent neutral treatment as Back. */
export const ONBOARDING_PREVIEW_SECONDARY_CTA_CLASS =
  "bg-[#e2e2e2]/30 text-foreground hover:bg-[#e2e2e2]/50 hover:text-foreground";
