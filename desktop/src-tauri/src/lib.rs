...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            set_shared_instructions_enabled,
            ...
            managed_agents::create_shared_instruction,
            managed_agents::update_shared_instruction,
            managed_agents::list_my_shared_instructions,
            managed_agents::resolve_shared_instructions,
