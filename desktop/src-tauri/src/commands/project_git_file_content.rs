...
use super::project_git_exec::{
    build_git_clone_auth_config, clean_branch, clean_target_ref, normalize_local_clone_url,
    run_git, validate_local_clone_url_for_workspace, GitAuthConfig,
};
...
pub async fn get_project_repo_file_content(
    ...
    let clone_url = normalize_local_clone_url(&clone_url);
