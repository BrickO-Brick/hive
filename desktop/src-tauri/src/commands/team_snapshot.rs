...
fn definition_from_snapshot(
    ...
    Ok(AgentDefinition {
        ...
        catalog_source: None,
        assigned_shared_instructions: member.definition.assigned_shared_instructions.clone(),
...
pub async fn confirm_team_snapshot_import(
    ...
    for (member, definition) in snapshot.members.iter().zip(definitions) {
        ...
        let record = ManagedAgentRecord {
            ...
            source_team_persona_slug: None,
            catalog_source: None,
            assigned_shared_instructions: definition.assigned_shared_instructions.clone(),
