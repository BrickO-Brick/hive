...
pub use nip_fi::{
    ...
    DenialClass, ExactProtectedUse, FederatedAssertionVerifier, FederatedIdentity,
    FederatedIdentityDiscovery, FreshnessClass, HttpJwksFetcher, IssuerJwksConfig, IssuerKeySource,
    IssuerPolicy, IssuerPolicyError, IssuerRegistry, JwksFetchError, JwksFetcher, NipFiMode,
    ...
    SubjectClassContract, TokenClass, TransportContractId, VerifiedAssertion,
    VerifiedServerDirectContext, VerifierError, CLIENT_ATTACHED_HEADER, NOSTR_PUBKEY_CLAIM,
