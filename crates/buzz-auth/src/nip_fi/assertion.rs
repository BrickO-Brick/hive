...
///
/// This module is compiled only under `#[cfg(test)]` — it is never included
/// in production builds.  Integration tests in `buzz-relay` and other crates
/// use this to mint synthetic assertions for pg_integration test fixtures.
#[cfg(test)]
