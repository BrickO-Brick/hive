...
pub struct CliArgs {
    ...
    /// at startup and exposed as compact instruction covers; bodies remain lazy.
    #[arg(
        long,
        env = "BUZZ_ACP_ASSIGNED_SHARED_INSTRUCTIONS",
        value_delimiter = ','
    )]
...
pub struct Config {
    ...
    pub team_instructions: Option<String>,
    /// Owner-assigned exact kind-30023 coordinates used to build instruction covers.
    ...
    pub fn from_args(mut args: CliArgs) -> Result<Self, ConfigError> {
        ...
        let config = Config {
            ...
            team_instructions: args
                ...
                .map(str::to_string),
            assigned_shared_instructions: args.assigned_shared_instructions.unwrap_or_default(),
