...
@objc class AppDelegate: FlutterAppDelegate, FlutterImplicitEngineDelegate {
  ...
  private func handleMediaUploadMethodCall(
    ...
    case "packageVoiceNoteForUpload":
      ...
      packageVoiceNoteForUpload(sourcePath: sourcePath, result: result)
  ...
  private func packageVoiceNoteForUpload(
    sourcePath: String,
    result: @escaping FlutterResult
  ) {
      ...
      let input = AVAssetWriterInput(
        ...
        outputSettings: [
          ...
          AVVideoCompressionPropertiesKey: [
            AVVideoAverageBitRateKey: 8_000,
  ...
  private func exportVoiceNoteEnvelope(
    sourceURL: URL,
    duration: CMTime,
    videoURL: URL,
    result: @escaping FlutterResult
