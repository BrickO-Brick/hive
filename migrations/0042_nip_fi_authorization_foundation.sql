...
--
-- `retained_until` is advisory: the claim is immutable and never deleted, but
-- a future pruning job may archive rows past this instant to cold storage once
-- the assertion's freshness deadline has safely expired.
