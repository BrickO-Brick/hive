...
export interface ProjectArtifactProjection {
  x: number;
  y: number;
  width: number;
  height: number;
  /** Clockwise screen-space silhouette of the rendered cube shell. */
...
export interface ProjectArtifactRendererProps {
  ...
  /** Springs the cube toward a side-facing task-detail orientation. */
  focusSide?: boolean;
  ...
  /** Reports the rendered cube shell bounds and silhouette in canvas pixels. */
