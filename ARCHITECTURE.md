...
**Partial rollout:** ACP harnesses without durable-wake support ignore kind `24620`, while upgraded ACP drops workflow-marked kind `9` messages that have not arrived through a successfully claimed durable wake. Relay and ACP must therefore both support the durable protocol before delegated workflow prompts execute; ordinary timeline visibility and ordinary messages are unaffected.
